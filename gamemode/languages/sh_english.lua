...
LANGUAGE = {
    ...
    misc = "Miscellaneous",
    oocNotify = "You must wait %s more seconds before using OOC again!",
    ...
    flagGiveAll = "%s has given all flags to %s.",
    flagTakeAll = "%s has taken all flags from %s.",
    ...
    whitelistAll = "%s has whitelisted %s for all factions.",
    unwhitelist = "%s has unwhitelisted %s from the %s faction.",
    unwhitelistAll = "%s has unwhitelisted %s from all factions.",
    ...
    optDisableOutlines = "Disable outlines",
    optdDisableOutlines = "Disables the outlines drawn around objects.",
    ...
    cmdCharGiveAllFlags = "Gives all flags to someone.",
    cmdCharTakeAllFlags = "Removes all flags from someone.",
    ...
    cmdPlyWhitelistAll = "Allows someone to create a character in all factions.",
    ...
    cmdPlyUnwhitelistAll = "Disallows someone to create a character in all factions, except for the default ones.",
    ...
    cmdCharSetRank = "Forcefully makes someone become the specified rank in their current faction.",
    ...
    iconEditorCopyDesc = "Copies the model data to your clipboard.",
    iconEditorCopied = "Copied Item Model Data to Clipboard.",
    iconEditorAlignFront = "Align from Front",
    iconEditorAlignFrontDesc = "Aligns the model from the front.",
    iconEditorAlignAbove = "Align from Above",
    iconEditorAlignAboveDesc = "Aligns the model from above.",
